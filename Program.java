...
public class Program {
	...
	public static void main(String[] args) {
		...
		Map<String, Weapon> otherItems = new HashMap<String, Weapon>();
		...
		for (File tweakFile : weaponFiles) {
 			Weapon w = weaponFactory.createWeaponFromFile(tweakFile,weapons);
			if (w == null) {
	...
	private static void populateSheet(HSSFSheet sheet, Map<String, Weapon> weapons) {
		int i=0;
		...
		Collections.sort(weaponList,comparator);
